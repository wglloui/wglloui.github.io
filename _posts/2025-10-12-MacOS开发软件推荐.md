...
## Yaak
Yaak是一款高性能、高安全性、开源免费的 API 请求客户端，可平替 Postman，支持使用 Git 或 Dropbox 等同步数据，使用基于 Rust 的 Tauri 框架开发。
- 官网：[Yaak – The API client for modern developers](https://yaak.app/)
- Github地址：[mountain-loop/yaak: The most intuitive desktop API client. Organize and execute REST, GraphQL, WebSockets, Server Sent Events, and gRPC 🦬](https://github.com/mountain-loop/yaak)
- 下载：[Release Release 2025.8.2 · mountain-loop/yaak](https://github.com/mountain-loop/yaak/releases/tag/v2025.8.2)